...
export default function ForgotPassword({ isOpen, onClose }) {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      const res = await fetch("https://serverluckyshop.luckyshop.com.bd/api/auth/forgot-send-otp", {
        method: "POST",
  ...
  const handleVerifyOtp = async () => {
    try {
      const res = await fetch("https://serverluckyshop.luckyshop.com.bd/api/auth/forgot-verify-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleResetPassword = async () => {
    ...
    try {
      const res = await fetch("https://serverluckyshop.luckyshop.com.bd/api/auth/reset-password", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
