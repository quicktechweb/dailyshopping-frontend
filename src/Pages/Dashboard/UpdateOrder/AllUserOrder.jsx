...
const fetchOrders = async () => {
  try {
    const res = await axios.get(
      "https://serverluckyshop.luckyshop.com.bd/api/orders"
    );
 ...
 const handleUpdate = async (id, newStatus) => {
  try {
    await axios.put(
      `https://serverluckyshop.luckyshop.com.bd/api/orders/${id}/status`,
      { status: newStatus }
    );
 ...
 const sendToSteadfast = async () => {
  ...
  try {
    ...
    const dbUpdate = await axios.put(
      "https://serverluckyshop.luckyshop.com.bd/api/bulk-consignment",
      { orders: updates }
    );
