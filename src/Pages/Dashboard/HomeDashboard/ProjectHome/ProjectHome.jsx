    ...
    async function fetchData() {
      try {
        const response = await fetch(
          `https://dailyshopping-backend.onrender.com/getprojecthome`
        );
  ...
  const handleDelete = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`https://dailyshopping-backend.onrender.com/homeprojectdelete/${id}`)
          .then((response) => {
            response.status === 204 &&
              ...
              <div className="min-w-[400px] md:min-w-[650px]">
                ...
                {data?.map((d, i) => (
                  ...
                  >
                    ...
                    <p className="w-[32%] text-left ms-8">
                      {d.description}
                    </p>
      ...
      <div className="w-[32%] flex items-center justify-center -ms-6">
        ...
        />
                    ...
                    <div className="w-[32%] flex items-center justify-center">
                      <NavLink
                        to={`/dashboard/editprojecthome/${d._id}`}
                        style={{
                          textDecoration: "none",
                          marginRight: "-10px",
                        }}
