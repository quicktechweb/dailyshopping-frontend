...
const EditProduct = () => {
  ...
  // Fetch banner data
  useEffect(() => {
    fetch(`https://serverluckyshop.luckyshop.com.bd/editproductdata/${id}`)
      .then((res) => res.json())
  ...
  const handleUpdate = async (e) => {
    ...
    fetch(`https://serverluckyshop.luckyshop.com.bd/productdataupdate/${id}`, {
      method: "PUT",
