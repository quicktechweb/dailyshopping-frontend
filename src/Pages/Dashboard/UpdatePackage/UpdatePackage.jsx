...
const UpdatePackage = () => {
  ...
  const fetchProducts = async () => {
    setLoading(true);
    try {
      const response = await axios.get(`https://serverluckyshop.luckyshop.com.bd/api/newproductss`); // Adjust endpoint
  ...
  const handleUpdate = async (productId, newPackageName) => {
    try {
      ...
      const response = await axios.put(
        `https://serverluckyshop.luckyshop.com.bd/api/products/update-package/${productId}`,
        updatedPackage
      );
