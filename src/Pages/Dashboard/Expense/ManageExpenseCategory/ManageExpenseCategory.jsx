...
const ManageExpenseCategory = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (editing) {
      await axios.put(
        `https://serverluckyshop.luckyshop.com.bd/api/expense-categories/${editing._id}`,
        { name, status }
      );
      setEditing(null);
    } else {
      await axios.post("https://serverluckyshop.luckyshop.com.bd/api/expense-categories", { name, status });
    }
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this category?")) {
      await axios.delete(`https://serverluckyshop.luckyshop.com.bd/api/expense-categories/${id}`);
      fetchCategories();
    }
  };
