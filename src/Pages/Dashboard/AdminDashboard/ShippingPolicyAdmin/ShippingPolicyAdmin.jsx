...
const ShippingPolicyAdmin = () => {
  ...
  const fetchData = async () => {
    try {
      const res = await axios.get("https://serverluckyshop.luckyshop.com.bd/api/shippingpolicy");
  ...
  const handleSave = async () => {
    try {
      await axios.put(`https://serverluckyshop.luckyshop.com.bd/api/shippingpolicy/${data._id}`, data);
