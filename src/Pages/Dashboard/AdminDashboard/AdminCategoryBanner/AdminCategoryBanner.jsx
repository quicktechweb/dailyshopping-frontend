...
const BASE_URL = "https://serverluckyshop.luckyshop.com.bd/api/categorybanner";
...
export default function AdminCategoryBanner() {
  ...
  const fetchCategories = async () => {
    try {
      const catRes = await axios.get("https://serverluckyshop.luckyshop.com.bd/api/categories");
