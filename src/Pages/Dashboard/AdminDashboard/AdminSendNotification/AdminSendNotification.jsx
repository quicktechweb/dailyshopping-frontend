...
console.log(notifications)
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const usersRes = await axios.get("https://serverluckyshop.luckyshop.com.bd/api/auth/active-users");
      ...
      const promises = users.map((u) =>
        axios.post("https://serverluckyshop.luckyshop.com.bd/api/notification/create", {
          userId: u._id,
          title,
          message,
        })
