...
const AdminWithdraw = () => {
 ...
 const fetchSummary = async () => {
  setLoading(true);
  try {
    const withdrawRes = await axios.get("https://serverluckyshop.luckyshop.com.bd/api/wallet/withdraw-summary");
    console.log("Withdraw summary response:", withdrawRes.data);

    const usersRes = await axios.get("https://serverluckyshop.luckyshop.com.bd/api/auth/alluser");
  ...
  const handleApprove = async (id) => {
    ...
    try {
      await axios.post(`https://serverluckyshop.luckyshop.com.bd/api/wallet/withdraw-approve/${id}`, { adminName: "Admin" });
      fetchSummary();
    } catch (err) {
      console.error(err);
  ...
  const handleReject = async (id) => {
    ...
    try {
      await axios.post(`https://serverluckyshop.luckyshop.com.bd/api/wallet/withdraw-reject/${id}`);
      fetchSummary();
    } catch (err) {
      console.error(err);
