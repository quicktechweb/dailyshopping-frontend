...
const PurchaseEntry = () => {
  ...
  // ✅ Fetch suppliers
  useEffect(() => {
    axios.get("https://serverluckyshop.luckyshop.com.bd/api/suppliers").then((res) => {
  ...
  // ✅ Fetch products
  useEffect(() => {
    axios.get("https://serverluckyshop.luckyshop.com.bd/api/products").then((res) => {
 ...
 const handlePaidChange = (value) => {
  ...
  try {
    await axios.post("https://serverluckyshop.luckyshop.com.bd/api/purchases", form);
