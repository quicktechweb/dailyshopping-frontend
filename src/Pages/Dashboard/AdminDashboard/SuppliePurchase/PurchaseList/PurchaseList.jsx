...
const PurchaseList = () => {
  ...
  useEffect(() => {
    const fetchPurchases = async () => {
      try {
        const res = await axios.get("https://serverluckyshop.luckyshop.com.bd/api/purchases");
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://serverluckyshop.luckyshop.com.bd/api/purchases/${id}`);
...
const paginatedPurchases = purchases.slice(
  ...
  const handleView = async (id) => {
    try {
      const res = await axios.get(`https://serverluckyshop.luckyshop.com.bd/api/purchases/${id}`);
  ...
  const handleSaveEdit = async () => {
    try {
      ...
      const res = await axios.put(
        `https://serverluckyshop.luckyshop.com.bd/api/purchases/${editingPurchase._id}`,
        updatedData
      );
