...
const SubAdmin = () => {
  ...
  // Fetch admin list
  useEffect(() => {
    fetch(`https://serverluckyshop.luckyshop.com.bd/getadminlist`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const handleAdmin = (e) => {
    ...
    fetch(`https://serverluckyshop.luckyshop.com.bd/userLogin/subadmin`, {
      method: "PUT",
      headers: {
  ...
  const handleDeleteAdmin = (phoneNumber) => {
    fetch(`https://serverluckyshop.luckyshop.com.bd/userLogin/subadmin/${phoneNumber}`, {
      method: "DELETE",
