...
const Wallet = () => {
  ...
  const fetchTransactions = async () => {
    if (!user?._id) return;
    try {
      const res = await axios.get(`https://serverluckyshop.luckyshop.com.bd/api/wallet/add-history/${user._id}`);
...
//     // 1️⃣ Add funds
//     const res = await axios.post("https://serverluckyshop.luckyshop.com.bd/api/wallet/add", {
//       userId: user._id,
 ...
 // --- bKash Add Funds flow ---
  ...
  const handleAddFunds = async () => {
    ...
    try {
      ...
      const res = await axios.post("https://serverluckyshop.luckyshop.com.bd/api/wallet/wallet/create", {
        userId: user._id,
        amount: parseFloat(amount),
      ...
      const onFocus = async () => {
        ...
        try {
          const userRes = await axios.get(`https://serverluckyshop.luckyshop.com.bd/api/users/${user._id}`); // you should have this route
  ...
  const handleWithdrawSubmit = async () => {
    ...
    try {
      setWithdrawing(true);
      const res = await axios.post("https://serverluckyshop.luckyshop.com.bd/api/wallet/withdraw-request", {
        userId: user._id,
