  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const topselling = res.data.filter((p) => p.type === "premium");
                ...
                <div className="p-2 flex-grow">
                  ...
                  <div className="mt-2 w-full">
                    <div className="flex justify-between items-center text-center gap-1">
                      ...
                      <div className="flex flex-col items-center flex-1">
                        <span className="text-sm font-bold text-yellow-600 whitespace-nowrap">{totalcupon}</span>
                        <span className="text-[11px] text-gray-500 whitespace-nowrap">Coupon</span>
                      </div>

                      <div className="w-px h-8 bg-gray-200"></div>

                      <div className="flex flex-col items-center flex-1">
                        <span className="text-sm font-bold text-gray-800 whitespace-nowrap">{remaining}</span>
                        <span className="text-[11px] text-gray-500 whitespace-nowrap">Remaining</span>
                      </div>
                    </div>
                  </div>
                </div>
